            ...
            <View style={styles.rightContainer}>
                <View>
                    ...
                    <Text style={styles.message}>
                        {item && item.messages && item.messages.length ? item.messages[item.messages.length - 1].text : "Nhấn để bắt đầu nhắn tin"}
                    </Text>
                </View>
                <View>
                    <Text style={styles.time}>
                        {item && item.messages && item.messages.length ? item.messages[item.messages.length - 1].time : "Ngay bây giờ"}
                    </Text>
                </View>
            </View>
        </Pressable>
